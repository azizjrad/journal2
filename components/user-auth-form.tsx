...
export function UserAuthForm({ onSuccess, redirectTo }: LoginFormProps) {
  ...
  const handleGoogleRegister = async () => {
    try {
      // Redirect to Google OAuth (same flow, but can be differentiated on backend)
                ...
                <form onSubmit={handleLogin} className="space-y-4">
                  ...
                  <div className="relative my-6">
                    <div className="absolute inset-0 flex items-center">
                      <span className="w-full border-t border-gray-300/20" />
                    </div>
                  ...
                  <Button
                    ...
                    className="w-full bg-white/10 border-white/20 text-white hover:bg-white/20 font-semibold"
                  >
