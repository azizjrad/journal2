      ...
      <div className="min-h-screen bg-gray-50 py-12">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            {/* Admin Dashboard Card (conditionally shown) */}
            <Link href="/admin">
              <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-all duration-300 border border-gray-200 hover:border-purple-300 group cursor-pointer">
                <div className="flex items-center mb-6">
                ...
                <p className="text-gray-600 mb-4">
                  Access administrative tools, user management, and content
                  moderation
                </p>
                <ul className="text-sm text-gray-500 space-y-2">
            ...
            {/* Writer Dashboard Card (conditionally shown) */}
            <Link href="/admin">
              <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-all duration-300 border border-gray-200 hover:border-green-300 group cursor-pointer">
                <div className="flex items-center mb-6">
                ...
                <p className="text-gray-600 mb-4">
                  Create and manage your articles, track performance, and view
                  analytics
                </p>
                <ul className="text-sm text-gray-500 space-y-2">
